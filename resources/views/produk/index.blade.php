    ...
    <div class="flex h-screen ">
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto bg-blue-100">
            ...
            <div class="p-6 ">
                ...
                <div class="btn">
                    <a href="{{ route('create-produk') }}" class=" mt-4 mb-2 rounded-lg inline-block text-white text-xl py-2 px-4 bg-blue-600">Tambah Produk</a>
                </div>
                    ...
                    <table class="min-w-full border-collapse bg-white border border-gray-300 rounded-lg">
                        <thead>
                            <tr>
                                ...
                                <th class="border py-2 px-4 border-b">Nama Produk</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="flex py-2 px-4 border-b justify-around">
                                    <a href="{{ route('edit-produk', $produks->id_produk)}}" class="fa-solid fa-pen-to-square text-2xl text-blue-500 hover:text-blue-600"></i></a>
